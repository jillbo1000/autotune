...
ab <- get_eztune_results("./data/eztune_data/Abalone", "Abalone", "svm")
bh <- get_eztune_results("./data/eztune_data/BostonHousing", "Boston Housing", "svm")
co2 <- get_eztune_results("./data/eztune_data/CO2", "CO2", "svm")
cr <- get_eztune_results("./data/eztune_data/Crime", "Crime", "svm")
oh <- get_eztune_results("./data/eztune_data/AmesHousing", "Ames Housing", "svm")
un <- get_eztune_results("./data/eztune_data/Union", "Union", "svm")
wa <- get_eztune_results("./data/eztune_data/Wage", "Wage", "svm")
...
# latex format
svm_reg_results <- results_table(dat = std_dat, best = best_results, 
                                 datasets = data_sets, model = "SVM")

write.table(svm_reg_results[[1]], "./tables/tableB1_svm_reg_text.txt", 
            quote = FALSE,  col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(svm_reg_results[[2]], "./tables/tableB1_svm_reg_latex.txt", 
