...
bc <- get_eztune_results("./data/eztune_data/BreastCancer", "Breast Cancer", "ada")
io <- get_eztune_results("./data/eztune_data/Ionosphere", "Ionosphere", "ada")
pi <- get_eztune_results("./data/eztune_data/Pima", "Pima", "ada")
so <- get_eztune_results("./data/eztune_data/Sonar", "Sonar", "ada")
li <- get_eztune_results("./data/eztune_data/Lichen", "Lichen", "ada")
mu <- get_eztune_results("./data/eztune_data/Mullein", "Mullein", "ada")
...
# latex format
ada_bin_results <- results_table(dat = std_dat, best = best_results, 
                                 datasets = data_sets, model = "ada")

write.table(ada_bin_results[[1]], "./tables/tableB5_ada_class_text.txt", 
            quote = FALSE,  col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(ada_bin_results[[2]], "./tables/tableB5_ada_class_latex.txt", 
