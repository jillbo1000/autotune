...
bc <- get_eztune_results("./data/eztune_data/BreastCancer", "Breast Cancer", "svm")
io <- get_eztune_results("./data/eztune_data/Ionosphere", "Ionosphere", "svm")
pi <- get_eztune_results("./data/eztune_data/Pima", "Pima", "svm")
so <- get_eztune_results("./data/eztune_data/Sonar", "Sonar", "svm")
li <- get_eztune_results("./data/eztune_data/Lichen", "Lichen", "svm")
mu <- get_eztune_results("./data/eztune_data/Mullein", "Mullein", "svm")
...
# latex format
svm_bin_results <- results_table(dat = std_dat, best = best_results, 
                                 datasets = data_sets, model = "SVM")

write.table(svm_bin_results[[1]], "./tables/tableB3_svm_class_text.txt", 
            quote = FALSE,  col.names = TRUE, row.names = FALSE, sep = "\t")
write.table(svm_bin_results[[2]], "./tables/tableB3_svm_class_latex.txt", 
