...
ab.dat <- get_opt_data("./data/optimization_data/svm/Regression/Abalone/", 
                       "Abalone")
bh.dat <- get_opt_data("./data/optimization_data/svm/Regression/Boston Housing/", 
                       "Boston Housing")
co.dat <- get_opt_data("./data/optimization_data/svm/Regression/CO2/", 
                       "CO2")
cr.dat <- get_opt_data("./data/optimization_data/svm/Regression/Crime/",
                       "Crime")
oh.dat <- get_opt_data("./data/optimization_data/svm/Regression/Ohio Housing/", 
                       "Ohio Housing")
un.dat <- get_opt_data("./data/optimization_data/svm/Regression/Union/", 
                       "Union")
wa.dat <- get_opt_data("./data/optimization_data/svm/Regression/Wage/", 
                       "Wage")
...
abg <- datagridReg("./data/grid_data/svm/Regression/Abalone", 
                     dataset = "Abalone")
bhg <- datagridReg("./data/grid_data/svm/Regression/Boston Housing", 
                     dataset = "Boston Housing")
cog <- datagridReg("./data/grid_data/svm/Regression/CO2", 
                     dataset = "CO2")
crg <- datagridReg("./data/grid_data/svm/Regression/Crime", 
                     dataset = "Crime")
ohg <- datagridReg("./data/grid_data/svm/Regression/Ohio Housing", 
                     dataset = "Ohio Housing")
ung <- datagridReg("./data/grid_data/svm/Regression/Union", 
                     dataset = "Union")
wag <- datagridReg("./data/grid_data/svm/Regression/Wage", 
                     dataset = "Wage")


best_results <- cbind.data.frame(rep("", 7), rep(0, 7), rep(0, 7))
colnames(best_results) <- c("Data", "MES_UCL", "TimeUCL")
...
# Transform data by subtracting the best error obtained on the grid, then
...
# Add in reasonable values for the missing Mullein data
